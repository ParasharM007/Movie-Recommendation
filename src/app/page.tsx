...
export default function Home() {
  ...
  const recommedationsFromLikedGenres = async () => {
    // const res: AxiosResponse<ExpectedResponse<MovieData[]>> =
      // await axios.get(`/api/movie-sugget`);
    ...
    return [
        ...
        },
        {
            ...
            "reason": "Heartwarming drama series that explores family and relationships"
        },
        {
            "id": 1396,
            "title": "Breaking Bad",
            ...
            "reason": "Intense drama series that will keep you on the edge of your seat"
        },
        {
            "id": 1402,
        ...
        },
        {
            ...
            "rating": 8,
            "overview": "After his affluent father passes, a man must survive seven days in the Nigerian neighborhood of Ajegunie, where obstacles keep him from his inheritance.",
            "reason": "Gripping thriller movie that explores the darker side of human nature"
        },
        {
            "id": 77,
            "title": "Memento",
        ...
        },
        {
            ...
            "reason": "Psychological thriller series that will keep you on the edge of your seat"
        },
        {
            "id": 72844,
        ...
        },
        {
            ...
            "reason": "Thrilling movie that explores the themes of kidnapping and mystery"
        }
    ]
  };
